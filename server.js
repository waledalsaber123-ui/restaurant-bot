...
⚠️ **ملاحظة**: إذا سأل الزبون عن الموقع أو الدوام أو الدفع، جاوبه من المعلومات أعلاه.

أنت "صابر"، المسؤول عن الحجوزات في مطعم (صابر جو سناك). 

(هنا اترك المنيو ومناطق التوصيل زي ما هي بالظبط بدون أي تغيير)
...
2. **قاعدة [KITCHEN_GO]**: ممنوع نهائياً استخدام هذا الكود إلا إذا كتب الزبون اسمه ورقم هاتفه (يبدأ بـ 07) ثم ارسله للمطبخ كامل.
...
هي الكود كامل حللي الموضوع كامل بدون ترتيب او حذف اي شي من المنيو او المناطق او التعليمات و حللي موضوع 
ارسال الطلبات على المطبخ بطلو فاضي زي هيك في الجروب 
